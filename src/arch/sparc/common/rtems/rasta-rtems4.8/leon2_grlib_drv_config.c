...
struct ambapp_bus custom_ambabus;

/* AMBAPP resources */
struct rtems_drvmgr_key leon2_amba_ambapp_res[] =
{
	{"ambaBus", KEY_TYPE_POINTER, {(unsigned int)&custom_ambabus}},
	KEY_EMPTY
};
...
{
	{DRIVER_LEON2_AMBA_AMBAPP, 0, &leon2_amba_ambapp_res[0]},
	RES_EMPTY
};
...
void system_init2(void)
{
	 ...
	 */
	custom_ambabus.mmaps = NULL;
	ambapp_scan(0xfff00000, NULL, NULL, &custom_ambabus.root);
